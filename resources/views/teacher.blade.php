                        ...
                        @foreach($teachers as $teacher)
                            <div class="col-md-6 col-sm-12 col-lg-6 mb-3" >
                                <div class="post-bx lst brd-rd5">
                                    <div class="post-thmb"><a title="" itemprop="url"><img
                                                src="{{asset('storage/' . $teacher->image)}}"
                                                style="min-width: 250px; min-height:250px; max-width: 250px; max-height:250px;"
                                                alt="post-img1-1.jpg" itemprop="image"></a></div>
                                    <div class="post-inf">
                                        <h5 itemprop="headline"><a href="#" title="" itemprop="url">
                                                {{ $teacher->name }}  </a></h5>
                                        <ul class="pst-mta">
                                            <li><i class="far fa-user theme-clr"></i>   {{ $teacher->title }} </li>
                                        </ul>
